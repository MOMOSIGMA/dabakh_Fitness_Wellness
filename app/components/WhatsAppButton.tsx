...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-6 z-[90] flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white px-5 py-4 rounded-full shadow-2xl hover:shadow-green-500/50 transition-all hover:scale-105 active:scale-95 group"
